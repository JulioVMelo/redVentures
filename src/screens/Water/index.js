...
export default function Water() {
  ...
  function handleSubmit() {
    history.push(`/sunlight/${sun}/water/${waterLevel}`);
  }
  ...
  return (
    <Ui.Container>
      ...
      <Ui.ListChoice>
        <div className="form">
          <Ui.Choice background={waterLevel === '1'} color="#7BAF9E">
            <input
              name="a"
              id="a"
              type="radio"
          ...
          <Ui.Choice background={waterLevel === '2'} color="#7BAF9E">
            <input
              name="a"
              id="b"
              type="radio"
          ...
          <Ui.Choice background={waterLevel === '3'} color="#7BAF9E">
            <input
              name="a"
              id="c"
              type="radio"
